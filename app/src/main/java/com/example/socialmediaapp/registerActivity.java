        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(txtUsername) || TextUtils.isEmpty(txtName)
                    ...
                    registerUser(txtUsername , txtName , txtEmail , txtPassword,status);
                }
            }
        });
    }
    private void registerUser(final String username, final String name, final String email, String password,String status) {
...
//                //Log.d("bug", "signInWithCustomToken:success");
